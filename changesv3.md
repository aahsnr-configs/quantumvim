...
return {
  {
    "catppuccin/nvim",
    priority = 1000,          -- Initialize color definitions at immediate execution lifecycle
    lazy = false,             -- Never defer loading the core theme engine
    config = function()
